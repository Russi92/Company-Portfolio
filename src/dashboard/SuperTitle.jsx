...
const SuperTitle = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 bg-gray-700 rounded-lg shadow max-w-3xl mx-auto mt-10">
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Edit Super Title</h2>
      ...
      {/* Main Image */}
      <label className="block mb-2 text-white font-semibold">Main Image</label>
      {mainImagePreview && (
      ...
      {/* Gallery Images */}
      <label className="block mb-2 text-white font-semibold">Gallery Images</label>
