...
//         background: "linear-gradient(180deg, #003A3A 0%, #007171 50%, #00B2B1 100%)"
//       }}>
//       <form
//         onSubmit={handleLogin}
//         className="bg-white p-8 rounded-lg shadow-md w-full max-w-md"
//       >
//         <h2 className="text-2xl font-bold mb-6 text-center text-black">Dashboard Login</h2>
...
//             className="w-full px-4 pe-8 py-2 border border-gray-300 rounded text-black focus:outline-none"
//             value={password}
